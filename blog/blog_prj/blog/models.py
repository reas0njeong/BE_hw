...
class Like(models.Model):
    user = models.ForeignKey(to=User,on_delete=models.CASCADE,related_name="user_lines")
    post = models.ForeignKey(to=Post,on_delete=models.CASCADE,related_name="post_lines")
